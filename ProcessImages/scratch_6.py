    ...
    while True:
        try:
            ...
            if i == 0:
                ...
                # [cv2.rectangle(overlay, (x, y), (x + w, y + h), (255, 0, 255), 2) for (x, y, w, h) in data]
...
def cam_output_face_detect(connection_obj, flip=True, haar_frontal='data/haarcascade_frontalface_default.xml',
                           haar_second=None):
    import cv2
    import matplotlib.pyplot as plt
    # init cam
